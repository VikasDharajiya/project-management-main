  ...
  return (
    <div className="mt-6 px-3">
      ...
      <div className="space-y-1 px-3">
        {projects.map((project) => {
          ...
          return (
            <div key={projectId}>
              ...
              >
                <ChevronRightIcon
                  className={`size-3 text-gray-500 dark:text-zinc-400 transition-transform duration-200 ${expandedProjects.has(projectId) ? "rotate-90" : ""}`}
                />
                <div
        ...
        {projects.length === 0 && (
          <p className="text-xs text-gray-400 dark:text-zinc-500 px-3 py-2">
