...
export default function ProjectDetail() {
  ...
  // Fetch tasks from API when project is found
  useEffect(() => {
    ...
    taskAPI
      .getByProject(workspaceId, projectId)
      ...
      <div className="flex max-md:flex-col gap-4 flex-wrap items-start justify-between max-w-6xl">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <span
              className={`px-2 py-1 rounded text-xs capitalize ${statusColors[project.status] || statusColors.PLANNING}`}
            >
