    ...
    <div className="space-y-6 max-w-6xl mx-auto">
      ...
      <div className="relative max-w-md">
        ...
        <input
          ...
          className="pl-8 w-full text-sm rounded-md border border-gray-300 dark:border-zinc-800 bg-white dark:bg-zinc-900 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-zinc-400 py-2 focus:outline-none focus:border-blue-500"
        />
      </div>
                    ...
                    return (
                      ...
                      >
                        <td className="px-6 py-2.5 whitespace-nowrap flex items-center gap-3">
                          <div className="size-7 rounded-full bg-zinc-300 dark:bg-zinc-700 flex items-center justify-center text-xs font-medium">
                            {u?.name?.[0] || u?.email?.[0] || "?"}
                          </div>
                        ...
                        <td className="px-6 py-2.5 whitespace-nowrap">
                          <span
                            className={`px-2 py-1 text-xs rounded-md ${member.role === "owner" || member.role === "ADMIN" ? "bg-purple-100 dark:bg-purple-500/20 text-purple-500 dark:text-purple-400" : "bg-gray-200 dark:bg-zinc-700 text-gray-700 dark:text-zinc-300"}`}
                          >
                            {member.role || "member"}
                          </span>
                        </td>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3 mb-2">
                      <div className="size-9 rounded-full bg-zinc-300 dark:bg-zinc-700 flex items-center justify-center text-sm font-medium">
                        {u?.name?.[0] || "?"}
                      </div>
                      <div>
